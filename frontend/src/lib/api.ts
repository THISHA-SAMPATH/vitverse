...
export const focApi = {
  ...
  reportPdf: (semester: string) => api.get(`/foc/report/${encodeURIComponent(semester)}/pdf`, { responseType: 'blob' }),
...
export const portfolioApi = {
  ...
  resumePdf: () => api.get('/portfolio/me/resume/pdf', { responseType: 'blob' }),
